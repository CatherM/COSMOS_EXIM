...
T0_metabolomic <- as.data.frame(read_csv(path_T0_metabolomic_data))
names(T0_metabolomic)[names(T0_metabolomic) == "...1"] <- "metabolite"

T0_transcriptomic <- as.data.frame(read_csv(path_T0_transcriptomic_data))
rownames(T0_transcriptomic) <- T0_transcriptomic$...1

T48_metabolomic <- as.data.frame(read_csv(path_T48_metabolomic_data))
names(T48_metabolomic)[names(T48_metabolomic) == "...1"] <- "metabolite"

T48_transcriptomic <-  as.data.frame(read_csv(path_T48_transcriptomic_data))
...
First, three methods are explored in the following three chunks. Then, the main method, which can be adjusted, is seperately applied to the T0 and T48 gene expression datasets to estimate TF activity.
