...
### Method exploration
For now, methods wmean, Ulm and consensus are exploren. Perhaps MLM will be added later but for now I am lazy. Thanks.
...
Consensus
Consensus has a two-step approach, as it does not allow for colinear regulons, these will be filtered out of the PKN before using it as input. 
1. Adjusting PKN
```{r}
