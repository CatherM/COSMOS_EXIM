...
```
There are some outliers in the left-most bins. This is especially notable in the histogram representing the log-transformed values in the unstimulated dataset (T0). What metabolites are causing these left-most bins and why are the values so low?
