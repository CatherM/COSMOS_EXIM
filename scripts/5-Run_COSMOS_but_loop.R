...
for (i in 1:2){
  ...
  for (patient in names(cosmos_inputs)){
    ...
    tryCatch({
      ...
      filter <- "s10m05" ## This one is important!! s = signalling input, m = metabolte input filter
