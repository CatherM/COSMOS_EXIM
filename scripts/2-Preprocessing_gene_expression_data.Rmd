...
# 
## day0_RNA_path <- "../ourdata/transcriptomic/day0_RNA_raw.csv" # Do not use these?
## day2_RNA_path <- "../ourdata/transcriptomic/day2_RNA_raw.csv" # We do not use these
...
For day0, where there are 10 samples, this means to keep all samples where <8 out of 9 are NA. In other words, There need to be at least 2 measurements to keep this one. 
For day2, this means to keep samples where less than 6.4 out of 8 are NA. In other words, There need to be at least 3 measurements for the gene to not be filtered out
