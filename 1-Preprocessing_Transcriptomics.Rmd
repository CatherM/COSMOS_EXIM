...
This R Markdown document is a translation of the Rscripts 'RNA.R' from the Factor_COSMOS github page, specifically the no_MOFA branch. The script can be found at Factor_COSMOS/scripts/RNA.R
