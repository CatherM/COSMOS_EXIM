...
# metabs_df <-  as.data.frame(read_csv("L:\\basic\\divg\\EXIM\\ImmunoHematology\\Cathy Magnée\\Data\\CD3_HDvsCLL\\Metabolomic\\day2_metabs_raw.csv"))
metabs_df <-  as.data.frame(read_csv("L:\\basic\\divg\\EXIM\\ImmunoHematology\\Cathy Magnée\\Data\\CD3_HDvsCLL\\Metabolomic\\all_metabs_raw.csv"))
...
pheatmap(log2(as.matrix(na.omit(metabs_df))), show_colnames = T, show_rownames = F) 
